...
Once the `conda-forge` channel has been enabled, `penaltymodel` can be installed with:

```
conda install penaltymodel
```

It is possible to list all of the versions of `penaltymodel` available on your platform with:
